        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if ((todoList === null || todoList === void 0 ? void 0 : todoList.length) == 0) {
                        todoListContainer.innerHTML += "\n    <div class=\"todo\">\n        <span> You do not have any tasks </span>\n    </div>\n    ";
                    }
                    else {
                        todoList === null || todoList === void 0 ? void 0 : todoList.forEach(function (todo) {
                            todoListContainer.innerHTML += "\n      <div class=\"todo\">\n        <span>".concat(todo.title, " </span>\n\n        <div class=\"actions\">\n           <button class=\"edit\">\n              <i class=\"fas fa-edit\"></i>\n          </button>\n          <button data-id=").concat(todo.id, " class=\"delete\">\n             <i class=\"fas fa-trash-alt\"></i>\n          </button>\n        </div>\n\n        </div>\n      ");
                        });
                    }
                    deleteTaskButton();
                    return [2 /*return*/];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(localhostAddress, "/").concat(TodoID), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createTodos(data)];
                case 1:
                    _a.sent();
                    displayTodos();
                    newTodoInput.value = '';
